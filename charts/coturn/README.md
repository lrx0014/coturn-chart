...
![Version: 9.4.1](https://img.shields.io/badge/Version-9.4.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.8.0](https://img.shields.io/badge/AppVersion-4.8.0-informational?style=flat-square)
...
| service.annotations | object | `{}` | annotations to add to both TCP and UDP services |
...
| service.nodePorts | object | `{"dtls":null,"tcp":null,"tls":null,"udp":null}` | optional fixed NodePort values for NodePort service type.    Leave blank to allow Kubernetes to allocate a value automatically. |
| service.nodePorts.dtls | string | `nil` | fixed NodePort for the TURN DTLS UDP listening port |
| service.nodePorts.tcp | string | `nil` | fixed NodePort for the TURN TCP listening port |
| service.nodePorts.tls | string | `nil` | fixed NodePort for the TURN TLS TCP listening port |
| service.nodePorts.udp | string | `nil` | fixed NodePort for the TURN UDP listening port |
